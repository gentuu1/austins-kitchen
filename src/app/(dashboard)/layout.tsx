...
export default function DashboardLayout({ children, }: { children: ReactNode }) {
    ...
    return (
        <div className="bg-zinc-50 w-screen h-screen lg:flex-row flex md:flex-col-reverse flex-col-reverse">
            ...
            <div className={`border-t shadow-2xl lg:border-t-0 lg:shadow-none w-full lg:w-62 fixed bottom-0 left-0 md:fixed lg:relative md:bg-zinc-100 bg-[#1F2933] z-50 `}>
                ...
                <div className=" w-full h-fit p-5 flex lg:flex-col lg:space-y-3 justify-between md:text-gray-700 text-white ">
